                        ...
                        <>
                          ...
                          <div className="item-time-card-detail">
                            <div className="item-time-card-row">
                              ...
                              <span className="item-time-card-date">
                                {new Date(spotTimePricing.earlyBirdDate + 'T00:00').toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                              </span>
                            </div>
                            <div className="item-time-card-row">
                              <span className="icon-circle" style={{ width: 32, height: 32, minWidth: 32 }}>
                              ...
                              <span className="item-time-card-label">Price per spot</span>
                              <div className="price-input-wrap">
                                <span className="price-prefix">$</span>
                                <input
                                  type="text"
                        ...
                        <>
                          ...
                          <div className="item-time-card-detail">
                            <div className="item-time-card-row">
                              ...
                              <span className="item-time-card-date">
                                {new Date(spotTimePricing.lateFeeDate + 'T00:00').toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                              </span>
                            </div>
                            <div className="item-time-card-row">
                              <span className="icon-circle" style={{ width: 32, height: 32, minWidth: 32 }}>
